...
-- beautiful.init("/home/andre/.config/awesome/themes/nice-and-clean-theme/theme.lua")

--print(awful.util.getdir("config") .. "/conscience-awesome-theme/theme.lua")
--beautiful.init(awful.util.getdir("config") .. "/conscience-awesome-theme/theme.lua")
-- beautiful.onscreen.init()
require("keydoc")


-- LAUNCH BAR
icon_dir = "/home/andre/.config/awesome/conscience-awesome-theme/night/icons"
-- launchbar.icon_dirs = { icon_dir }
...
--            if s == 1 then
--                wallpaper_cmd = "awsetbg '/home/andre/Documents/Perso/201301-Milford Track/201212-070-Milford Track.jpg'"
--                awful.util.spawn(wallpaper_cmd)
--            elseif s == 2 then
--                wallpaper_cmd = "awsetbg '/home/andre/Documents/Perso/201301-Milford Track/201212-016-Milford Track.jpg'"
--                awful.util.spawn(wallpaper_cmd)
--            end
--        end)
--    end
